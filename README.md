...
The organization-root GitHub Pages site for [Apollo Theme](https://github.com/apollo-theme/apollo-theme). It presents the canonical palette and 17 permanent application ports through clearly labeled simulated interfaces.
...
- `palette/apollo.json` — exact copy of the canonical Apollo palette
...
- `assets/site.css` — responsive and accessible presentation
- `previews/` — exactly 17 app-specific, social-preview-sized SVG simulations
...
Apollo is derived from Gruvbox Dark Hard through SonicTerm’s modified near-black variant. The canonical lineage metadata is carried in `palette/apollo.json`.
